...
from handlers import register_handlers, check_inactive_users, send_weekly_report, send_daily_topic, send_active_user_of_the_day
...
if __name__ == '__main__':
    ...
    async def set_commands(_):
        commands = [
            ...
            types.BotCommand(command="challenge", description="Текущий челлендж дня"),
            ...
            types.BotCommand(command="end_game", description="Завершить активную игру"),
            types.BotCommand(command="set_cooldown", description="Установить ограничение на частоту игр (для админов)"),
            types.BotCommand(command="check_inactive", description="Проверить неактивных пользователей (для админов)"),
            types.BotCommand(command="send_report", description="Отправить отчет об активности (для админов)"),
            types.BotCommand(command="send_daily_topic", description="Отправить тему дня для обсуждения (для админов)"),
            types.BotCommand(command="active_user_of_day", description="Объявить самого активного пользователя дня (для админов)"),
